...
class Satellite : public CelestialBody {
  public:
    Satellite(double s, double m, string c, string n, string h) 
      : CelestialBody(s, m, c, n), host_planet(h) {}

    string GetHostPlanet() const {
      return host_planet;
    }
...
class Planet : public CelestialBody {
  public:
    Planet(double s, double m, string c, string n, string h) 
      : CelestialBody(s, m, c, n), host_star(h) {}

    string GetHostStar() const {
      return host_star;
    }
